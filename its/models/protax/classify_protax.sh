...
## modified from "step4.txt" in Protax distribution
# shell variables PROTAX (directory containing protax scripts),
# MDIR (directory containing trained model files), and ODIR should be set before
# running this script

SIMFILE1=test.m8

usearch -usearch_global test.fa\
        -db $MDIR/refs.udb\
        -id 0.75\
        -maxaccepts 1000\
        -strand both\
